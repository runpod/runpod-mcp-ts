...
async function runpodRequest(endpoint, method = "GET", body) {
...
server.tool("update-endpoint", {
    ...
    const result = await runpodRequest(`/endpoints/${endpointId}`, "PATCH", updateParams);
    return {
        content: [
            {
                type: "text",
...
// Delete Endpoint
server.tool("delete-endpoint", {
    endpointId: z.string().describe("ID of the endpoint to delete"),
}, async (params) => {
    const result = await runpodRequest(`/endpoints/${params.endpointId}`, "DELETE");
    return {
        content: [
            {
                type: "text",
...
server.tool("delete-template", {
    ...
    const result = await runpodRequest(`/templates/${params.templateId}`, "DELETE");
    return {
        content: [
            {
                type: "text",
...
server.tool("get-network-volume", {
    networkVolumeId: z
        .string()
        .describe("ID of the network volume to retrieve"),
}, async (params) => {
    const result = await runpodRequest(`/networkvolumes/${params.networkVolumeId}`);
    return {
        content: [
            {
                type: "text",
...
server.tool("create-network-volume", {
...
server.tool("update-network-volume", {
    ...
    const result = await runpodRequest(`/networkvolumes/${networkVolumeId}`, "PATCH", updateParams);
    return {
        content: [
            {
                type: "text",
...
server.tool("delete-network-volume", {
    networkVolumeId: z.string().describe("ID of the network volume to delete"),
}, async (params) => {
    const result = await runpodRequest(`/networkvolumes/${params.networkVolumeId}`, "DELETE");
    return {
        content: [
            {
                type: "text",
...
server.tool("get-container-registry-auth", {
    containerRegistryAuthId: z
        .string()
        .describe("ID of the container registry auth to retrieve"),
}, async (params) => {
    const result = await runpodRequest(`/containerregistryauth/${params.containerRegistryAuthId}`);
    return {
        content: [
            {
                type: "text",
...
server.tool("delete-container-registry-auth", {
    ...
    const result = await runpodRequest(`/containerregistryauth/${params.containerRegistryAuthId}`, "DELETE");
    return {
        content: [
            {
                type: "text",
